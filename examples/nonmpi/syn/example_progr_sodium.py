...
mod.add_spectral({'Name': 'spec1', 'Wavelength': [5890, 5900, 150], 'topology': 'ch1', 'LOS': [theta,0.0,90.0], 'Boundary condition': [1.0,0.0,0.0,0.0]})
mod.add_chromosphere({'Name': 'ch1', 'Spectral region': 'spec1', 'Height': 3.0, 'Line': '5895', 'Wavelength': [5890, 5900], 'Reference frame': reference})
mod.setup()
