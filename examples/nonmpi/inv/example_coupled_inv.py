...
mod = hazel.Model('../../configurations/conf_inv_D3_10830.ini', working_mode='inversion', verbose=4, root='../../')
...
ax[0].plot(obs1[:,0])
ax[0].plot(f['spec1']['stokes'][0,0,0,:])

ax[1].plot(obs2[:,0])
ax[1].plot(f['spec2']['stokes'][0,0,0,:])
