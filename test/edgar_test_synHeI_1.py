...
mod = hazel.Model(working_mode='synthesis',verbose=1) 
...
# ch1.set_pars([20.,10.,10.,3.,0.,8.,1.,0.02],j10=[0.,0.,0.,0.])
...
#TBD: 
#introduce archivo atomico dinamicamente por python, que cuando se indique atom
#en add_chromosphere ya selecciones el archivo de atom que se tiene que leer

#el "wavelength" de add_chromosphere podriamos cogerlo de add_spectral


#    !DELETE:
#    !open(unit=15,file='HERE.ME',action='write',status='replace')
#    !write(15,FMT='(F5.4)') 1.0
#    !CLOSE(15)
#    !STOP
